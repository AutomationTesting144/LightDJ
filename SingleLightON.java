...
public class SingleLightON {
    ...
    public void SingleLightON (AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException  {
        ...
        Object lightNameObject = jsonObject3.get("on");
...

        {
            ...
            Comments = "NA";
            ExpectedResult= "Light: "+lightName+ " should be turned ON";
