...
public class LightBrightness {
    ...
    public void LightBrightness (AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException  {
        ...
        //Setting brightness
        driver.findElement(By.id("com.lightdjapp.lightdj.demo:id/brightnessSeekBar")).click();
        TimeUnit.SECONDS.sleep(2);
        ...
        Object lightNameObject = jsonObject3.get("bri");
        lightName = lightNameObject.toString();
        System.out.println("Brightness: "+lightName);

        if (lightName.equals("50"))

        {
            Status = "0";
            ActualResult ="Brightness is not reduced for the lights";
            Comments = "FAIL:Brightness is not reduced for the lights: "+newString1;
            ExpectedResult= "Brightness of the lights should be reduced";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);


        } else {
            Status = "1";
            ActualResult ="Brightness is reduced for the lights";
            Comments = "N/A";
            ExpectedResult= "Brightness of the lights should be reduced";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
