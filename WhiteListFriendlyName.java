...
public class WhiteListFriendlyName {
    ...
    public void WhiteListFriendlyName(AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws JSONException, IOException {
        ...
        if(whitelistString.contains("Light DJ")){
            Status = "1";
            ActualResult = "Bridge has User Friendly whitelist name for Light DJ";
            Comments = "NA";
            ExpectedResult= "Bridge should have User Friendly whitelist name for Light DJ";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);

        }
        else {
            Status = "0";
            ActualResult = "Bridge does not have User Friendly whitelist name for Light DJ";
