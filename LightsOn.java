...
public class LightsOn {
    ...
    public void LightsOn (AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException  {
        ...
        {
            Status = "1";
            ActualResult = "All the lights are turned ON";
            Comments = "NA";
            ExpectedResult= "All the lights should be TURNED ON";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        } else {
            Status = "0";
            ActualResult = "All the lights are not turned ON";
