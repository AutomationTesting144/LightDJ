...
import org.openqa.selenium.By;import java.io.BufferedReader;
import java.io.File;
...
public class SingleLightBrightness {
    ...
    public void SingleLightBrightness (AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException  {
        ...
        if (LightStatus.equals("50"))
        {
            Status = "0";
            ActualResult = "Brightness is not reduced for the light: "+lightName;
            Comments = "FAIL: Lights are not turned ON. Status of lights are: "+newString1;
            ExpectedResult= "Brightness should be reduced for the light: "+lightName;
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        }
        else
        {
            Status = "1";
            ActualResult = "Brightness is reduced for the light: "+lightName;
            Comments = "NA";
            ExpectedResult= "Brightness should be reduced for the light: "+lightName;
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        }
