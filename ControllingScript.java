...
public class ControllingScript {
    ...
    public void testRuns() throws Exception {
        ...
        for(int i=0;i<oldFiles.length;i++){
            ...
            Boolean status = oldFiles[i].getName().contains("LightDJAutomationResults");
            ...
            if(status==true){
                ...
                if(filename1.contains(Currentdate)){
                    ...
                    filename = "C:\\Users\\310287808\\AndroidStudioProjects\\AnkitasTrial\\LightDJAutomationResults-"+Currentdate+".xls";
        ...
        for(int i=0;i<newFiles.length;i++) {
            Boolean fileYesNo=newFiles[i].getName().contains("LightDJAutomationResults");
...
//        LightsVerificationHue  verification=new LightsVerificationHue();
//        verification.LightsVerificationHue(driver,resultFileName,APIVersion,SWVersion);
//
//        LightsOn  ON=new LightsOn();
//        ON.LightsOn(driver,resultFileName,APIVersion,SWVersion);
//
//        LightBrightness  brightness=new LightBrightness();
//        brightness.LightBrightness(driver,resultFileName,APIVersion,SWVersion);
//
//        ColorChangeAll  changeAll=new ColorChangeAll();
//        changeAll.ColorChangeAll(driver,resultFileName,APIVersion,SWVersion);
//
//        SingleLightON  SingleON=new SingleLightON();
//        SingleON.SingleLightON(driver,resultFileName,APIVersion,SWVersion);
//
...
//
//        SingleLightBrightness  BrightnessSingle=new SingleLightBrightness();
//        BrightnessSingle.SingleLightBrightness(driver,resultFileName,APIVersion,SWVersion);

//        LightAdditionHue  addition=new LightAdditionHue();
//        addition.LightAdditionHue(driver,resultFileName,APIVersion,SWVersion);
//
//        NewlyAddedLightControl  LightControl=new NewlyAddedLightControl();
//        LightControl.NewlyAddedLightControl(driver,resultFileName,APIVersion,SWVersion);

//        LightRenameHue  rename=new LightRenameHue();
//        rename.LightRenameHue(driver,resultFileName,APIVersion,SWVersion);
//
//        LightDeletionHue  deletion=new LightDeletionHue();
//        deletion.LightDeletionHue(driver,resultFileName,APIVersion,SWVersion);
